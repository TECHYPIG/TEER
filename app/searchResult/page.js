...
function UserList(props) {
    ...
    return (
      <>
        ...
        <div class="bg-white border border-gray-100 w-full mt-2 rounded-xl shadow-xl ">
      
      <div class="pl-8 pr-2 py-1 border-b-2 border-gray-100 relative cursor-pointer hover:bg-yellow-50 hover:text-gray-900">
          <div class="mr-4">
          <svg class="stroke-current absolute w-4 h-4 left-2 top-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
          <div class="font-bold text-lg"> {user.Username}</div>
          <div class="text-xs text-gray-500">
            <span class="mr-2"> <b>Location:</b> {user.Location}</span>
            <span class="mr-2"> <b>Role:</b> {user.Role}</span>
          </div>
